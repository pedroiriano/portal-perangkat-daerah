                ...
                <div>
                    ...
                    <table id="example" class="display" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center"><i class="uil uil-document-info" style="font-size:24px"></i></td>
                                <td>{{ $item['title'] }}</td>
                                <td class="text-center">
                                    <a href="https://cms.depok.go.id/upload/file/{{ $item['uploaddokumen'] }}" type="button" target="_blank">
            ...
            <div class="lg:col-span-4 md:col-span-6">
                <div class="sticky top-20">
                    ...
                    <div class="flex items-center justify-center mt-8">
                        <div class="ml-3">
                            <a href="/informasi/produk" class="font-semibold hover:text-indigo-600" aria-selected="true">
                                Dokumen Produk
                            </a>
                        </div>
                    </div>
